<div class="login-box">
	<div class="login-logo">
		<h5 style="font-weight: bold; font-family: Clarendon Blk BT; font-size: 24pt;">SISTEM INFORMASI MONITORING TUGAS AKHIR</h5>
	</div>
	<!-- /.login-logo -->
	<div class="login-box-body">
		<p class="login-box-msg text-bold" style="font-family: Broadway; font-size: 17pt;"> WELCOME</p><br>
		<form method="post" action="<?php echo base_url('auth/login'); ?>" role="login">
			...
			<div class="form-group has-feedback">
				<input type="password" name="password" class="form-control" required minlength="5" placeholder="Password" /><br>
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-6 col-md-6" style="padding-bottom: 5px">
					<button type="submit" name="submit" value="login" class="btn btn-primary btn-block btn-flat"><i class="fa fa-sign-in" aria-hidden="true"></i> Login</button>
				</div>
			</div>
